...
$sqlCanceladas = "SELECT COUNT(*) as canceladas
FROM solicitacoes
WHERE sol_status = 'recusada' AND sol_data BETWEEN :dataInicio AND :dataFim";

$stmtCanceladas = $conexao->prepare($sqlCanceladas);
$stmtCanceladas->bindParam(':dataInicio', $dataInicio);
$stmtCanceladas->bindParam(':dataFim', $dataFim);
$stmtCanceladas->execute();
$dadosCanceladas = $stmtCanceladas->fetch(PDO::FETCH_ASSOC);
